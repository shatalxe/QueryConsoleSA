...
Функция НовыйВыводЗначенийСвойств()
	...
	Дерево.Колонки.Добавить("ЗначениеПредставление");
...
Процедура ВыводЗначенийСвойствЗаполнитьДеревоСвойств(Форма, ВыводЗначений, Значение)
	
	Строки = ВыводЗначений.Дерево.Строки;
...
Процедура ДобавитьРеквизитыЗначенияНаФорму(Форма, ГруппаФормы, МассивНовыхРеквизитов, Значение, СчетчикТаблиц = 0, СчетчикПолей = 0);
	...
	ИначеЕсли ЭтоСсылочныйТип(Значение) Тогда
		...
		ВыводЗначений = НовыйВыводЗначенийСвойств(); 
		ВыводЗначенийСвойствЗаполнитьДеревоСвойств(Форма, ВыводЗначений, Значение);
...
Процедура ДобавитьЭлементРезультатаНаФорму(Форма, ГруппаФормы, МассивЗначений, ТекущееЗначение, СчетчикТаблиц = 0, СчетчикПолей = 0)
	...
	Если ТипЗнч(ТекущееЗначение) = Тип("ТаблицаЗначений")
		...
		Если ТипЗнч(ТекущееЗначение) = Тип("ДеревоЗначений") Тогда
			ЭлементТаблица.Отображение = ОтображениеТаблицы.Дерево;	
			// TODO Добавить команды Свернуть/Сазвернуть
		КонецЕсли;
	...
	ИначеЕсли ЭтоСсылочныйТип(ТекущееЗначение) Тогда
		
		ДобавитьЭлементРезультатаНаФорму(Форма, ГруппаФормы, МассивЗначений, ВыводЗначений.Дерево);
...
Процедура ДобавитьНеотображаемыйЭлементФормы(ВладелецПоля, ИмяЭлемента, Значение)
	...
	ВладелецПоля[ИмяЭлемента+"Представление"] = ПредставлениеЗначения(Значение);
...
Функция ПредставлениеЗначения(Значение)
	...
	ИначеЕсли ТипЗначения = Тип("МоментВремени") Или ТипЗначения = Тип("Тип") Тогда
