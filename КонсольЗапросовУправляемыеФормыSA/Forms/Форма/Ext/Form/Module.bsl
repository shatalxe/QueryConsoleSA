...
Процедура Подключаемый_ВыборРезультата(Элемент)
	...
	Если Элемент.ТекущийЭлемент.ГиперссылкаЯчейки Тогда
		...
		ОткрытьФорму("ВнешняяОбработка.КонсольЗапросовУправляемыеФормыSA.Форма.ФормаЗначенияВОтдельномОкне",ПараметрыФормы,ЭтаФорма);
...
Процедура Подключаемый_ПоказатьЗначениеВОтдельномОкне(Команда)
	...
	ПоказатьЗначениеВОтдельномОкне(ЭтаФорма, Команда);
...
&НаКлиенте
Процедура ПоказатьЗначениеВОтдельномОкне(Форма, Команда) Экспорт
	...
	ОткрытьФорму("ВнешняяОбработка.КонсольЗапросовУправляемыеФормыSA.Форма.ВычислениеВыражения", ПараметрыФормы, Форма, Истина);
