...
Процедура ВыполнитьЗапрос(Команда)
	...
	Задание = НовоеЗадание(Отказ, "ВыполнитьЗапрос", Истина);
...
Процедура Подключаемый_ВыполнитьЗапросВременнаяТаблица(Команда)
	...
	Задание = НовоеЗадание(Отказ, "ВыполнитьЗапрос", Истина, , Команда.Имя);
...
Процедура ВыполнитьПакет(Команда)
	...
	Задание = НовоеЗадание(Отказ, "ВыполнитьЗапрос", Истина, Истина);
...
Процедура ВыполнитьПроизвольныйКод(Команда)
	...
	Задание = НовоеЗадание(Отказ, "ВыполнитьКод");
...
Процедура ВыполнитьВнешнееСоединение(Команда)
	...
	Задание = НовоеЗадание(Отказ, МетодВнешнееСоединениеЗапрос(), Истина);
...
Процедура ВыполнитьЗаданиеНаКлиенте(ЭтотОбъект, ПараметрыВыполнения, Отказ)
	...
	СтрокаРезультата = ЭтотОбъект.Объект.Вставить(0);
...
&НаКлиенте
Функция НовоеЗадание(Отказ, ИмяМетода, ЭтоЗапрос = Ложь, Пакет = Ложь, ИмяВременнойТаблицы = "");
