...
Процедура Подключаемый_ПоказатьЗначениеВОтдельномОкне(Команда)
	...
	ПараметрыФормы = Новый Структура();
	Если Таблица.Отображение = ОтображениеТаблицы.Список Тогда
		ПараметрыФормы.Вставить("Выражение","ВладелецФормы."+Таблица.Имя+"["+Таблица.ТекущаяСтрока+"]");
	Иначе

		МассивИндексов = Новый Массив;
		ЗаполнитьПутьКТекущейСтрокеДерева(ЭтаФорма[Таблица.Имя], Таблица.ТекущиеДанные, МассивИндексов);
		
		Выражение = "ВладелецФормы." + Таблица.Имя;
		...
		//Путь + ".ПолучитьЭлементы()[" + Индекс + "]";
		
		//ПараметрыФормы.Вставить("Выражение",ПолучитьПутьКСтрокеДерева(ЭтаФорма[Таблица.Имя], "ВладелецФормы." + Таблица.Имя, Таблица.ТекущиеДанные));	
...
//&НаКлиенте
//Функция ПолучитьПутьКСтрокеДерева(Дерево, Путь, ТекущиеДанные)
...
//		Путь = Путь + ".ПолучитьЭлементы()[" + Индекс + "]";
//		Возврат Путь;
//		
//	КонецЕсли;
//	
...
//	Путь = Путь + ".ПолучитьЭлементы()[" + Индекс + "]";
//	
//	ПолучитьПутьКСтрокеДерева(Дерево, Путь, Родитель);
//	
//	Возврат Путь;
...
&НаКлиенте
Процедура ЗаполнитьПутьКТекущейСтрокеДерева(Дерево, ТекущиеДанные, МассивИндексов)
	...
	Индекс = Родитель.ПолучитьЭлементы().Индекс(ТекущиеДанные);	
	МассивИндексов.Добавить(Индекс);	
	ЗаполнитьПутьКТекущейСтрокеДерева(Дерево, Родитель, МассивИндексов);
