...
Функция ДобавитьЗначение(Знач Родитель, Знач Свойство, Знач Значение)
	...
	Если ТипЗнч(Значение) = Тип("ДанныеФормыЭлементКоллекции")
		...
		ВыражениеРодителя = Сред(Выражение,1,СтрДлина(Выражение) - СтрДлина(МассивЧастей[МассивЧастей.Количество()-1])-1);
...
&НаСервере
Функция ДобавитьЗначениеНаСервере(Знач Родитель, Знач Свойство, Знач Значение)
...
Функция ПолучитьСтруктуруСтроки(Таблица, ИдентификаторСтроки)
	...
	Колонки = ДанныеФормыВЗначение(Таблица,Тип("ТаблицаЗначений")).Колонки;
